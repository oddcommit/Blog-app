...
const BlogField:React.FC<Props> = (props) =>{

  let url = './img/'.concat(props.url.slice(12, props.url.length));


    return (
        <button className="mx-10" id={props.created_at} onClick={props.viewBlog}>
          <img className="object-cover w-full h-60 rounded-lg lg:w-96" src={url} alt='alex-knight'/>
